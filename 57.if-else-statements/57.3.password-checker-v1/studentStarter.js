...
function setup() {
  ...
  function checkPassword() {
    // ADD CODE: hide both images by default

    // ADD CODE: add if statement that checks if the user entered password
    // matches the stored password

    if (passwordUI) {
      // ADD CODE: show unlocked image, change result text, change result color.
    }
  }
}
