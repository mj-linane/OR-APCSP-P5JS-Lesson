...
let instructions = 0
const andy = Scene.getItem('OqQEkcF4')
...
while (seenInstructions === false) {
  andy.onActivate(() => {
    switch (true) {
      ...
      case instructions === 1:
        andy.say(
          "I am training to be the world's first robot personal assistant.",
        )
        instructions += 1
        break
      case instructions === 2:
      ...
      case instructions === 3:
        andy.say(
          'I want to deliver these mail packages to the people here as quickly as possible.',
        )
        instructions += 1
        break
      case instructions === 4:
      ...
      case instructions === 5:
        andy.say(
          'The people we must deliver to are marked as P1, P2, P3, and P4 on the map.',
        )
        instructions += 1
        break
      case instructions === 6:
        andy.say(
          'I will need to create an algorithm that will help me to get these mail packages to the people as quickly as possible.',
        )
        instructions += 1
        break
      case instructions === 7:
