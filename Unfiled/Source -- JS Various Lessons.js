...
//con sole.    log(name + age);      onsole.log(age + age);
...
con      .log(name + ' is a ' + age + ' years old ' + job + '. Is he married? ' + isMarried + '.');

age = 'thirty six';
job = 'driver';

console.log(name + '      a ' + age + ' years old ' + job + '. Is he married? ' + isMarried + '.');
...
if (isMarried === 'yes') {
    ...
    console.log(name + ' will hopefully ma      soon :)');
}
