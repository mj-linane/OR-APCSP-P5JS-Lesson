...
function createOutputBox() {
  ...
  output.style('margin-left: auto')
  output.style('margin-right: auto')
  output.style('top: 300')
  output.style('background-color: white')
  output.style('padding: 60px')
}
...
function createDisplayBtn() {
  ...
  function displayOutput() {
    ...
    output.html(
      ...
      ' That was a wonderful pet that I loved  we then went on to go for a ride in the park')
