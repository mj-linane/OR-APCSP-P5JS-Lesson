...
function preload() {
  const url =
    'http://api.openweathermap.org/data/2.5/weather?zip=02739&units=imperial&APPID=2acad937ffe0ddfb37cf4b76eeb5d094'
  json = loadJSON(url)
}
...
function draw() {
  ...
  then we have a color scale of 160 points.
  To figure out where in that 160 point range we need to be,
